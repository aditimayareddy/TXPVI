Texas Senate district boundaries from 02/28/12 to 12/31/21 (shapefile)
...
Texas Senate district boundaries for 02/28/12 to 12/31/21 were retrieved from https://redistricting.lls.edu/state/texas

##Processing
Texas Senate district boundaries were retrieved with a python script. 
...
##Additional Notes
For more information on the data see the AAR page at: https://redistricting.lls.edu/state/texas
